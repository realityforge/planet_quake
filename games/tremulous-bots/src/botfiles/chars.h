...
#define CHARACTERISTIC_AIM_ACCURACY_PAIN_SAW        9	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			10	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_LAS_GUN     	11	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_MASS_DRIVER	    12	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		13	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PULSE_RIFLE		14	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_FLAMER			15	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_LUCIFERCANNON   16	//float [0, 1]
//skill when aiming
...
#define CHARACTERISTIC_AIM_SKILL_PULSE_RIFLE			    18	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_LUCIFERCANNON		19	//float [0, 1]
//========================================================
//chat
//========================================================
//file with chats
...
//========================================================
//item weight file
#define CHARACTERISTIC_ITEMWEIGHTS					39	//string
//the aggression of the bot
#define CHARACTERISTIC_AGGRESSION					40	//float [0, 1]
//the self preservation of the bot (rockets near walls etc.)
#define CHARACTERISTIC_SELFPRESERVATION				41	//float [0, 1]
//how likely the bot is to take revenge
#define CHARACTERISTIC_VENGEFULNESS					42	//float [0, 1]	//use this!!
//tendency to camp
#define CHARACTERISTIC_CAMPER						43	//float [0, 1]
//========================================================
//========================================================
//tendency to get easy frags
#define CHARACTERISTIC_EASY_FRAGGER					44	//float [0, 1]
//how alert the bot is (view distance)
#define CHARACTERISTIC_ALERTNESS					45	//float [0, 1]
//how much the bot fires it's weapon
#define CHARACTERISTIC_FIRETHROTTLE					46	//float [0, 1]
