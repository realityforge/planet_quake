...
/* sounds */ "sound/weapons/vulcan/wvulwind.wav"
...

	{
		"item_armor_jacket", 
		"sound/misc/ar2_pkup.wav",
        { "models/powerups/armor/armor_jac.md3",
		0, 0, 0},
/* icon */		"icons/iconr_jac",
/* pickup */	"Jacket",
		25,
		IT_ARMOR,
		0,
...
//freeze
	...
	case IT_WEAPON:
//freeze
		if ( ent->modelindex2 == 255 && ps->stats[ STAT_WEAPONS ] & ( 1 << item->giTag ) && ps->ammo[ item->giTag ] > (2 * item->quantity) ) {
			return qfalse;
		}
//freeze
...
#ifdef CGAME
		if (!osp) BG_AddPredictableEventToPlayerstate( EV_JUMP_PAD, effectNum, ps );
#else
...
void BG_PlayerStateToEntityStateExtraPolate( playerState_t *ps, entityState_t *s, int time, qboolean snap ) {
	...
	s->pos.trDuration = 30; // 1000 / sv_fps (default = 20)
