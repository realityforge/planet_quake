...
{
	{
		2, qtrue, 1, 0, 0, 0, 1, 0, 0, qtrue
	},
	{
		0, qtrue, 1, 1, 1, 0, 0, 0, 0, qtrue
	},
	{
		0, qtrue, 1, 0, 1, 0, 0, 0, 0, qtrue
	},
	{
		2, qtrue, 2, 0, 0, 0, 1, 0, 0, qtrue
	},
	{
		3, qtrue, 2, 0, 2, 2, 1, 1, 0, qtrue	// JDC: this was tq 3
	},
	{
		8, qtrue, 3, 0, 2, 2, 2, 1, 0, qtrue
	}
};
...
static void GraphicsOptions_SetMenuItems( void )
{
	...
	if ( s_graphicsoptions.mode.curvalue < 0 )
	{
		s_graphicsoptions.mode.curvalue = 8;
	}
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.network.generic.flags		= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED;
