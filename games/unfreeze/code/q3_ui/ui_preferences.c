...
static void Preferences_MenuInit( void ) {
	...
	s_preferences.wallmarks.generic.flags	      = QMF_PULSEIFFOCUS|QMF_SMALLFONT|QMF_GRAYED;
	...
	s_preferences.allowdownload.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT|QMF_GRAYED;
