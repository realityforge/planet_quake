...
#define TEAM_OVERLAY_MAXNAME_WIDTH	9
#define TEAM_OVERLAY_MAXLOCATION_WIDTH	12

#define	DEFAULT_MODEL			"keel"
#ifdef MISSIONPACK
...
typedef struct {
	...
	qhandle_t	frozenFriendShader;

	qhandle_t	balloonShader;
	qhandle_t	connectionShader;

	qhandle_t	selectShader;
	qhandle_t	selectShaderWide;
...
typedef struct {
	...
	int				scores1p, scores2p;		// from configstrings
...
extern	vmCvar_t		cg_noExplosions;
extern	vmCvar_t		cg_oldRail;
extern	vmCvar_t		cg_oldRocket;
extern	vmCvar_t		cg_oldPlasma;
extern	vmCvar_t		cg_lgrcore;
...
extern	vmCvar_t		cg_noFragMessage;
extern	vmCvar_t		cg_noMapSounds;
extern	vmCvar_t		cg_noWeaponSounds;
extern	vmCvar_t		cg_oldRailSound;
extern	vmCvar_t		cg_friendMarkColor;
extern	vmCvar_t		cg_frozenFriendMark;
extern	vmCvar_t		cg_legit;
