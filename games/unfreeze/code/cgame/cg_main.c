...
int forceSkinModificationCount = -1;
...
vmCvar_t	cg_noFragMessage;
vmCvar_t	cg_noMapSounds;
vmCvar_t	cg_noWeaponSounds;
vmCvar_t	cg_oldRailSound;
vmCvar_t	cg_friendMarkColor;
vmCvar_t	cg_frozenFriendMark;
vmCvar_t	cg_legit;
...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_crosshairColor, "cg_crosshairColor", "6", CVAR_ARCHIVE },
	{ &cg_weaponSelectTime, "cg_weaponSelectTime", "2.1", CVAR_ARCHIVE },
	{ &cg_crosshairX, "cg_crosshairX", "0", CVAR_ARCHIVE },
	{ &cg_crosshairY, "cg_crosshairY", "0", CVAR_ARCHIVE },
	{ &cg_brassTime, "cg_brassTime", "0", CVAR_ARCHIVE },
	{ &cg_simpleItems, "cg_simpleItems", "0", CVAR_ARCHIVE },
	{ &cg_marksTime, "cg_marksTime", "0", CVAR_ARCHIVE },
...
//freeze
	...
	{ &cg_forceModel, "cg_forceModel", "3", CVAR_ARCHIVE  },
	{ &cg_forceSkin, "cg_forceSkin", "1", CVAR_ARCHIVE  },
	{ &enemy_model, "enemy_model", "keel", CVAR_ARCHIVE },
	{ &enemy_headmodel, "enemy_headmodel", "keel", CVAR_ARCHIVE },
	...
	{ &cg_teamOverlayUserinfo, "teamoverlay2", "0", CVAR_ROM | CVAR_USERINFO },
	...
	{ &pmove_fixed, "pmove_fixed", "0", CVAR_ROM},
	{ &pmove_msec, "pmove_msec", "5", 0},
	{ &cg_noTaunt, "cg_noTaunt", "0", CVAR_ARCHIVE},
	{ &cg_noExplosions, "cg_noExplosions", "0", CVAR_ARCHIVE},
	{ &cg_smallFont, "ui_smallFont", "0.25", CVAR_ARCHIVE},
	{ &cg_bigFont, "ui_bigFont", "0.4", CVAR_ARCHIVE},
	{ &cg_oldRail, "cg_oldRail", "1", CVAR_ARCHIVE},
	{ &cg_oldRocket, "cg_oldRocket", "1", CVAR_ARCHIVE},
	{ &cg_oldPlasma, "cg_oldPlasma", "1", CVAR_ARCHIVE},
	{ &cg_lgrcore, "cg_lgrcore", "0", CVAR_ARCHIVE},
//unlagged - client options
...
//unlagged - client options
	{ &cg_trueLightning, "cg_trueLightning", "0.5", CVAR_ARCHIVE},
	//nochatbeep
	{ &cg_nochatbeep, "cg_nochatbeep", "0", CVAR_ARCHIVE},
	//nochatbeep
//	{ &cg_pmove_fixed, "cg_pmove_fixed", "0", CVAR_USERINFO | CVAR_ARCHIVE }
	{ &cg_noFragMessage, "cg_noFragMessage", "0", CVAR_ARCHIVE},
	{ &cg_noMapSounds, "cg_noMapSounds", "1", CVAR_ARCHIVE},
	{ &cg_noWeaponSounds, "cg_noWeaponSounds", "1", CVAR_ARCHIVE},
	{ &cg_oldRailSound, "cg_oldRailSound", "1", CVAR_ARCHIVE},
	{ &cg_friendMarkColor, "cg_friendMarkColor", "7", CVAR_ARCHIVE},
	{ &cg_frozenFriendMark, "cg_frozenFriendMark", "0", CVAR_ARCHIVE},
	{ &cg_legit, "cg_legit", "1", CVAR_ROM}
};
...
void CG_RegisterCvars( void ) {
	...
	forceSkinModificationCount = cg_forceSkin.modificationCount;
	enemyModelModificationCount = enemy_model.modificationCount;
	enemyHeadModelModificationCount = enemy_headmodel.modificationCount;
...
//unlagged - client options
	...
	if ( drawTeamOverlayModificationCount != cg_drawTeamOverlay.modificationCount ) {
		...
		if ( cg_drawTeamOverlay.integer > 0 ) {
			trap_Cvar_Set( "teamoverlay2", "1" );
		} else {
			trap_Cvar_Set( "teamoverlay2", "0" );
		}
		// FIXME E3 HACK
	}

	// if model settings changed
	if ( forceModelModificationCount != cg_forceModel.modificationCount || forceSkinModificationCount != cg_forceSkin.modificationCount || enemyModelModificationCount != enemy_model.modificationCount || enemyHeadModelModificationCount != enemy_headmodel.modificationCount ) {
		forceModelModificationCount = cg_forceModel.modificationCount;
		forceSkinModificationCount = cg_forceSkin.modificationCount;
		enemyModelModificationCount = enemy_model.modificationCount;
		enemyHeadModelModificationCount = enemy_headmodel.modificationCount;
...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.selectShaderWide = trap_R_RegisterShader( "gfx/2d/selectwide" );
...
//freeze
	...
	if ( cgs.gametype >= GT_TEAM || cg_buildScript.integer ) {
		if (cg_drawFriend.integer > 1) cgs.media.friendShader = trap_R_RegisterShader( "sprites/foe3" ); else cgs.media.friendShader = trap_R_RegisterShader( "sprites/foe" );
		cgs.media.frozenFriendShader = trap_R_RegisterShader( "sprites/foe5" );
...
//freeze
		  ...
		  break;
			case 2:
				if ( (sp->client < 16 && cg.snap->ps.stats[ STAT_CLIENTS_READY ] & ( 1 << sp->client )) || (sp->client > 15 && sp->client < 32 && cg.snap->ps.stats[ STAT_CLIENTS_READY2 ] & ( 1 << (sp->client-16) )) ) {
//freeze
					if ( !Q_Isfreeze( sp->client ) )
//freeze
					return "Ready";
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum ) {
	...
	if (cgs.glconfig.vidHeight * 4 > cgs.glconfig.vidWidth * 3) {
		cgs.screenXScale = cgs.glconfig.vidWidth / 640.0;
		cgs.screenYScale = cgs.screenXScale;
		cgs.screenYBias = 0.5 * ( cgs.glconfig.vidHeight - ( cgs.glconfig.vidWidth * 3 / 4 ) ); 
	} else {
		cgs.screenYScale = cgs.glconfig.vidHeight / 480.0;
		cgs.screenXScale = cgs.screenYScale;
		cgs.screenXBias = 0.5 * ( cgs.glconfig.vidWidth - ( cgs.glconfig.vidHeight * 4 / 3 ) );
	}
