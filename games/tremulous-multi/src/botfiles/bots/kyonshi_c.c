...
skill 1
{
	...
	CHARACTERISTIC_AIM_ACCURACY_PAIN_SAW        0.2
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			0.4
	CHARACTERISTIC_AIM_ACCURACY_LAS_GUN     	0.3
	CHARACTERISTIC_AIM_ACCURACY_MASS_DRIVER		0.2
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.1
	CHARACTERISTIC_AIM_ACCURACY_PULSE_RIFLE		0.4
	CHARACTERISTIC_AIM_ACCURACY_FLAMER			0.2
...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_LAS_GUN     	0.8
	...
	CHARACTERISTIC_AIM_ACCURACY_LUCIFERCANNON   0.9
...
skill 5
{
	...
	CHARACTERISTIC_AIM_ACCURACY_FLAMER			0.8
