...
void                        TraceLine( mapTrace_t *trace );
float                       SetupTrace( mapTrace_t *trace );
...
void                        SetupDirt( void );
float                       DirtForSample( mapTrace_t *trace );
void                        DirtyRawLightmap( int num );

void                        SetupFloodLight( void );
float                       FloodLightForSample( mapTrace_t *trace );
...
void                        FreeTraceLights( mapTrace_t *trace );
void                        CreateTraceLightsForBounds( vec3_t mins, vec3_t maxs, vec3_t normal, int numClusters, int *clusters, int flags, mapTrace_t *trace );
void                        CreateTraceLightsForSurface( int num, mapTrace_t *trace );
