...
#define DF_AASENTNUMBER(x)		(x - aasworld[aasgvm].entities)
#define DF_NUMBERAASENT(x)		(&aasworld[aasgvm].entities[x])
#define DF_AASENTCLIENT(x)		(x - aasworld[aasgvm].entities - 1)
#define DF_CLIENTAASENT(x)		(&aasworld[aasgvm].entities[x + 1])
