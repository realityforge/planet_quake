...
Some of the major features currently implemented are:
  ...
  * Server-side demos, recording for every client, [TheDoctor's method](http://openarena.ws/board/index.php?topic=4437.0). Server-side demos, [lrq3000 implementation](https://github.com/lrq3000/ioq3-server-side-demos) recording entire server state and spectating playback. [Cyrax' multiview protocol](http://edawn-mod.org/forum/viewtopic.php?f=6&t=7) for viewing all clients from one demo file. TODO: playing back dm_68 files for all players. MultiVM command `\load <ui,cgame,game>; \mvjoin`. TODO: mvtile display views in a grid +/- adds or subtracts a tile and x y clientnum can set a specific location. TODO: fast forward, rewind 10 seconds using baseline indexes in demo files.
  * Multiple map loader in parallel with teleport switch. Multiple QVM loading for supplemental UIs and multiview. TODO: fix SAMEORIGIN spawn type location works but camera angles change. TODO: add Cyrax' multiview protocol back in to the mix for staying connected to multiple server games at once in spectate mode?
