...
Some of the major features currently implemented are:
  ...
  * PNG support
  * Docker support
  * Removed SDL inputs, touch support on mobile works. TODO: fix mouse wheel in console, keys in console might not work after restarting renderer, GLimp_Init() called multiple times?
