...
Some of the major features currently implemented are:
  ...
  * Multiple map loader in parallel with teleport switch. Multiple QVM loading for supplemental UIs and multiview. TODO: fix SAMEORIGIN spawn type location works but camera angles change
