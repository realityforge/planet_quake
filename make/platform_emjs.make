...
EMJS_RELEASE_PATH:= $(ABSOLUTE_PATH)/$(BR)/.emscripten
EMJS_DEBUG_PATH  := $(ABSOLUTE_PATH)/$(BD)/.emscripten
...
pre-build:
	...
	@echo "EMSCRIPTEN_ROOT   = '$(EMSDK)/upstream/emscripten';"           >> $(B)/.emscripten
