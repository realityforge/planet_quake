...
ifeq ($(PLATFORM),js)
SYSTEM           += sys_main.o sys_snd.o 
endif # not js
ifeq ($(PLATFORM),wasm)
SYSTEM           += sys_main.o \
	SDL.o SDL_audio.o SDL_error.o \
	SDL_assert.o sys_snd.o SDL_sysmutex.o \
	SDL_atomic.o SDL_events.o SDL_dataqueue.o \
	SDL_spinlock.o SDL_audiocvt.o SDL_audiotypecvt.o \
